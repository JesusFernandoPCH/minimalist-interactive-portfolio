...
[MIT](LICENSE.txt) - Template original creado por [**midudev**](https://github.com/midudev/minimalist-portfolio-json) basado en el diseño de [**Bartosz Jarocki**](https://github.com/BartoszJarocki/cv). Adaptaciones y nuevas integraciones desarrolladas en este repositorio.
